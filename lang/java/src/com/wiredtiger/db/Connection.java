...
public class Connection {
 ...
 protected Connection(long cPtr, boolean cMemoryOwn) {
   ...
   swigCPtr = cPtr;
   wiredtigerJNI.Connection__java_init(swigCPtr, this, this);
 }
 ...
 protected static long getCPtr(Connection obj) {
  ...
  /**
   * @copydoc WT_CONNECTION::debug_info
   */
  public  int debug_info(String config) throws com.wiredtiger.db.WiredTigerException {
    return wiredtigerJNI.Connection_debug_info(swigCPtr, this, config);
  }
   ...
   */
  public  int configure_method(String method, String uri, String config, String type, String check) throws com.wiredtiger.db.WiredTigerException {
  ...
  /**
   * @copydoc WT_CONNECTION::query_timestamp
   */
  public  int query_timestamp(String hex_timestamp, String config) throws com.wiredtiger.db.WiredTigerException {
    return wiredtigerJNI.Connection_query_timestamp(swigCPtr, this, hex_timestamp, config);
  }

  
  /**
   * @copydoc WT_CONNECTION::set_timestamp
   */
  public  int set_timestamp(String config) throws com.wiredtiger.db.WiredTigerException {
    return wiredtigerJNI.Connection_set_timestamp(swigCPtr, this, config);
  }

  
  /**
   * @copydoc WT_CONNECTION::rollback_to_stable
   */
  public  int rollback_to_stable(String config) throws com.wiredtiger.db.WiredTigerException {
    return wiredtigerJNI.Connection_rollback_to_stable(swigCPtr, this, config);
  }
  ...
  protected int _java_init(Object jsess) {
    return wiredtigerJNI.Connection__java_init(swigCPtr, this, jsess);
  }
