...
public class Session {
 ...
 protected Session(long cPtr, boolean cMemoryOwn) {
   ...
   swigCPtr = cPtr;
   wiredtigerJNI.Session__java_init(swigCPtr, this, this);
 }
 ...
 protected static long getCPtr(Session obj) {
  ...
  /**
   * @copydoc WT_SESSION::alter
   */
  public  int alter(String name, String config) throws com.wiredtiger.db.WiredTigerException {
    return wiredtigerJNI.Session_alter(swigCPtr, this, name, config);
  }
  ...
  /**
   * @copydoc WT_SESSION::join
   */
  public  int join(Cursor join_cursor, Cursor ref_cursor, String config) throws com.wiredtiger.db.WiredTigerException {
    return wiredtigerJNI.Session_join(swigCPtr, this, Cursor.getCPtr(join_cursor), join_cursor, Cursor.getCPtr(ref_cursor), ref_cursor, config);
  }

  
  /**
   * @copydoc WT_SESSION::log_flush
   */
  public  int log_flush(String config) throws com.wiredtiger.db.WiredTigerException {
    return wiredtigerJNI.Session_log_flush(swigCPtr, this, config);
  }
   ...
   */
  public  int log_printf(String format) throws com.wiredtiger.db.WiredTigerException {
    return wiredtigerJNI.Session_log_printf(swigCPtr, this, format);
  }

  
  /**
   * @copydoc WT_SESSION::rebalance
   */
  public  int rebalance(String uri, String config) throws com.wiredtiger.db.WiredTigerException {
    return wiredtigerJNI.Session_rebalance(swigCPtr, this, uri, config);
  }
  ...
  /**
   * @copydoc WT_SESSION::reset
   */
  public  int reset() throws com.wiredtiger.db.WiredTigerException {
    return wiredtigerJNI.Session_reset(swigCPtr, this);
  }
  ...
  public  int truncate(String name, Cursor start, Cursor stop, String config) throws com.wiredtiger.db.WiredTigerException {
    return wiredtigerJNI.Session_truncate(swigCPtr, this, name, Cursor.getCPtr(start), start, Cursor.getCPtr(stop), stop, config);
  }
  ...
  /**
   * @copydoc WT_SESSION::prepare_transaction
   */
  public  int prepare_transaction(String config) throws com.wiredtiger.db.WiredTigerException {
    return wiredtigerJNI.Session_prepare_transaction(swigCPtr, this, config);
  }
  ...
  /**
   * @copydoc WT_SESSION::timestamp_transaction
   */
  public  int timestamp_transaction(String config) throws com.wiredtiger.db.WiredTigerException {
    return wiredtigerJNI.Session_timestamp_transaction(swigCPtr, this, config);
  }

  
  /**
   * @copydoc WT_SESSION::query_timestamp
   */
  public  int query_timestamp(String hex_timestamp, String config) throws com.wiredtiger.db.WiredTigerException {
    return wiredtigerJNI.Session_query_timestamp(swigCPtr, this, hex_timestamp, config);
  }
  ...
  /**
   * @copydoc WT_SESSION::snapshot
   */
  public  int snapshot(String config) throws com.wiredtiger.db.WiredTigerException {
    return wiredtigerJNI.Session_snapshot(swigCPtr, this, config);
  }

  
  /**
   * @copydoc WT_SESSION::transaction_sync
   */
  public  int transaction_sync(String config) throws com.wiredtiger.db.WiredTigerException {
    return wiredtigerJNI.Session_transaction_sync(swigCPtr, this, config);
  }

  
  /**
   * @copydoc WT_SESSION::breakpoint
   */
  public  int breakpoint() throws com.wiredtiger.db.WiredTigerException {
    return wiredtigerJNI.Session_breakpoint(swigCPtr, this);
  }

  protected int _java_init(Object jsess) {
    return wiredtigerJNI.Session__java_init(swigCPtr, this, jsess);
  }
